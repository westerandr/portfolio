  ...
  return (
    ...
    <a className="rounded-3xl inline-block overflow-hidden shadow-xl max-w-xs cursor-pointer transition ease-in-out hover:-translate-y-1 hover:scale-102 duration-300">
        <div className="relative group w-full overflow-hidden bg-black h-40 rounded-t-3xl">
            ...
            />
            <div className="absolute bg-gradient-to-t from-black w-full h-full flex items-end justify-center -inset-y-0"><h1 className="font-bold text-lg text-white shadow-black dark:text-gray-300 mb-2 pl-3 pr-1.5">{title}</h1></div>
        </div>
        <div className="bg-white dark:bg-slate-800">
            <div className="text-center px-3 pb-6 pt-2">
                <p className="mt-2 font-sans font-light text-slate-700 dark:text-gray-300 dark:font-bold">
                    {organization}
                </p>
            </div>
            <div className="flex justify-center pb-3 text-slate-700 dark:text-gray-300">
